...
<head>
  ...
  <title>APAE TATUÍ - Editar Cliente</title>
  ...
  <form method="POST" action="{{ route('clientes.update', $cliente->id) }}">
    ...
    <div class="form-grid">
      <div class="form-group">
        ...
        <input type="text" id="nome" name="nome" class="form-control" placeholder="Digite o nome completo" value="{{ old('nome', $cliente->nome) }}">
      </div>

      <div class="form-group">
        <label for="cpf">CPF ou CNPJ</label>
        <input type="text" id="cpf" name="cpf" class="form-control" placeholder="000.000.000-00" value="{{ old('cpf', $cliente->cpf) }}">
      </div>

      <div class="form-group">
        <label for="cidade">Cidade</label>
        <input type="text" id="cidade" name="cidade" class="form-control" placeholder="Cidade" value="{{ old('cidade', $cliente->cidade) }}">
      </div>

      <div class="form-group">
        <label for="telefone">Telefone</label>
        <input type="text" id="telefone" name="telefone" class="form-control" placeholder="(99) 99999-9999" value="{{ old('telefone', $cliente->telefone) }}">
      </div>

      <div class="form-group">
        <label for="email">E-mail</label>
        <input type="email" id="email" name="email" class="form-control" placeholder="cliente@email.com" value="{{ old('email', $cliente->email) }}">
      </div>
